...
Partial Class WeddingFAQ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ' Add the rows
        FAQTable.Rows.Add({1, "General Questions", "How do I book you for my wedding?", "To reserve your wedding date, I require a deposit and a signed contract. To get started, fill out the contact form on the <a href=""Weddings.aspx"">wedding page</a> to get a customized wedding quote."})
        FAQTable.Rows.Add({2, "General Questions", "Do you travel?", "All of my equipment is easily portable and I am happy to come to your wedding venue, home or church. Travel fees are in addition to my regular service costs. From the salon, it is $1/mile with a $15 minimum."})
        ...
        FAQTable.Rows.Add({4, "General Questions", "Can I see some pictures of your work?", "Check out my <a href='https://www.facebook.com/HairBarLouisville' target='_blank'>Facebook</a> & <a href='http://instagram.com/HairBarLouisville' target='_blank'>Instagram</a> pages to see pictures from past weddings!"})
        ...
        FAQTable.Rows.Add({11, "Trial", "Can my mother/maid of honor/bridesmaid have a trial too?", "Absolutely! I want everyone to feel comfortable on the wedding day. This is an additional cost to contracted services at $50/person."})

        FAQTable.Rows.Add({12, "Prices & Payments", "What are your prices?", "You can find my price list <a href='Weddings.aspx#prices'>here</a>."})
        FAQTable.Rows.Add({13, "Prices & Payments", "What kind of payments do you accept?", "I accept cash, checks, venmo, and all credit cards."})
