...
Partial Class WeddingFAQ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FAQTable.Rows.Add({2, "General Questions", "Do you travel?", "All of our equipment is easily portable and we are happy to come to your wedding venue, home or church. Travel fees are in addition to our regular service costs. From the salon, it is $1/mile with a $15 minimum."})
