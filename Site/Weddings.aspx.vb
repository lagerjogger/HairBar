...
Partial Class Weddings
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        FAQTable.Rows.Add({2, "General Questions", "Do you travel?", "All of my equipment is easily portable and I am happy to come to your wedding venue, home or church. I have found that this is more relaxing, not having to worry about running from place to place! Travel fees are in addition to my regular service costs. From the salon, it is $.50/mile roundtrip with a $10 minimum."})
        FAQTable.Rows.Add({3, "General Questions", "Can you handle big wedding parties?", "I can do hair for everyone in your party, including mothers of the bride and groom, flower girls, attendants or any other special guest you may have. If you have a wedding party of 6 or more, or limited time in which you can get ready, an additional stylist or assistant may be needed. There is no extra fee associated with this, and that stylist prices are the same as mine that are stated above."})
