<%@ Page Title="Hair Bar - Georgi" Language="VB" MasterPageFile="~/MainMaster.master" AutoEventWireup="false" CodeFile="Georgi.aspx.vb" Inherits="Georgi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" Runat="Server">
    <div class="row">
        <div class="col-sm-12 col-md-4 col-lg-6" style="text-align: center;">
            <img src="images/Georgi.jpg" alt="Georgi" style="width: 100%; max-width: 450px;" />
        </div>
